...
NormalLog  "Start installing the TencentCloud API SDK for Python."
sudo pip3 install tencentcloud-sdk-python -qq > /dev/null
NormalLog  "The TencentCloud API SDK for Python is successfully installed."
...
NormalLog "API parameter configuration is completed."
