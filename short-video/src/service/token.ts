...
export class TokenService {
    ...
    // 生成 Token
    public Generate(ctx: ServiceContext, userId: string, requestSource: string): TokenInfo {
    ...
    // 校验 Token
    public Verify(ctx: ServiceContext, token: string): TokenData | undefined {
        try {
            ...
            logger.error(ctx, `wrong token:${token}, error:`, error);
            return undefined;
        }
        return undefined;
    }
